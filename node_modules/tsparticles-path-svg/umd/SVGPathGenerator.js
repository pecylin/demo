    ...
    class SVGPathGenerator {
        ...
        generate(particle, delta) {
            ...
            if (particle.svgDirection === undefined) {
                particle.svgDirection = (0, tsparticles_engine_1.getRandom)() > 0.5 ? 0 : 1;
            }
            ...
            if (particle.svgStep === undefined) {
                particle.svgStep = (0, tsparticles_engine_1.randomInRange)({ min: 0, max: this._paths[particle.svgPathIndex].length }) * pxRatio;
            }
            if (particle.svgOffset === undefined) {
                particle.svgOffset = {
                    width: (0, tsparticles_engine_1.randomInRange)({ min: -this._width / 2, max: this._width / 2 }) * pxRatio,
                    height: (0, tsparticles_engine_1.randomInRange)({ min: -this._width / 2, max: this._width / 2 }) * pxRatio,
                };
            }
            ...
            if (path) {
                const pathElement = path.element, pos = pathElement.getPointAtLength(particle.svgStep), canvasSize = particle.container.canvas.size, offset = (0, tsparticles_engine_1.getPosition)(this._offset, canvasSize), scale = this._scale * pxRatio;
                particle.position.x =
            ...
            return tsparticles_engine_1.Vector.origin;
        }
        init(container) {
