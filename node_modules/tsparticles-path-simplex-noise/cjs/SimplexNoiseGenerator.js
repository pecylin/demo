...
class SimplexNoiseGenerator {
    constructor() {
        ...
        this._resetField = (container) => {
            ...
            this.noiseFunc = (0, simplex_1.makeNoise4D)(sourceOptions.seed ?? (0, tsparticles_engine_1.getRandom)());
        ...
        this.field = [];
        this.noiseFunc = (0, simplex_1.makeNoise4D)((0, tsparticles_engine_1.getRandom)());
        this.noiseW = 0;
        this.options = {
            size: 20,
            increment: 0.004,
    ...
    generate(particle) {
        ...
        }, v = tsparticles_engine_1.Vector.origin;
        if (!this.field ||
            !this.field[point.x] ||
