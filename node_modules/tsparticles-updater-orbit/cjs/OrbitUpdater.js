...
class OrbitUpdater {
    ...
    init(particle) {
        ...
        particle.orbitColor = (0, tsparticles_engine_1.rangeColorToHsl)(orbitOptions.color);
        particle.retina.orbitRadius =
            orbitOptions.radius !== undefined
                ? (0, tsparticles_engine_1.getRangeValue)(orbitOptions.radius) * container.retina.pixelRatio
                : undefined;
